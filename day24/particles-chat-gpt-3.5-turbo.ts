...
function simulateHailstones(hailstones: Hailstone[], steps: number): Hailstone[] {
...
function arePathsIntersecting(a: Hailstone, b: Hailstone): boolean {
...
function printIntersections(intersections: Intersection[]): void {
...
const input: string = `19, 13, 30 @ -2, 1, -2
  18, 19, 22 @ -1, -1, -2
  20, 25, 34 @ -2, -2, -4
  12, 31, 28 @ -1, -2, -1
  20, 19, 15 @ 1, -5, -3`;

const hailstones: Hailstone[] = parseInput(input);

const testAreaMinX: number = 7;
const testAreaMaxX: number = 27;
const testAreaMinY: number = 7;
const testAreaMaxY: number = 27;

const steps: number = 1000000; // Adjust the number of steps based on your input data
